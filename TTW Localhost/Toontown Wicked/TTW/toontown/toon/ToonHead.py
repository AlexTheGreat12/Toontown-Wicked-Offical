...
class ToonHead(Actor.Actor):
    ...
    def generateToonHead(self, copy, style, lods, forGui = 0):
        ...
        if headStyle == 'dls':
            ...
            filePrefix = HeadDict['e'] #Placeholder
            fix = self.__fixHeadShortShort #Fix until LongShort head is released
            headHeight = 0.75
        elif headStyle == 'ess':
            filePrefix = HeadDict['e'] #Placeholder
            fix = self.__fixHeadShortShort
            ...
            filePrefix = HeadDict['e'] #Placeholder
            fix = self.__fixHeadShortShort #Fix until ShortLong head is released
            headHeight = 0.5
        elif headStyle == 'ell':
            filePrefix = HeadDict['e'] #Placeholder
            fix = self.__fixHeadShortShort #Fix until LongLong head is released
            headHeight = 0.75
        elif headStyle == 'lls':
            filePrefix = HeadDict['l'] #Placeholder
            fix = self.__fixHeadShortShort #Fix until LongShort head is released
            headHeight = 0.75
        elif headStyle == 'lss':
            filePrefix = HeadDict['l'] #Placeholder
    ...
    def __fixHeadShortLong(self, style, lodName = None, copy = 1):
        ...
        if lodName == None:
            ...
            searchRoot = self.find('**/' + str(lodName))
        if animalType != 'duck' and animalType != 'horse' and animalType != 'deer' and animalType != 'crocodile':
