...
from toontown.cr import TTLocalizerEnglish as Localizer
from direct.gui.DirectGui import *

class DownloadWatcher(DirectObject):
    
    def __init__(self):
        self.text = DirectLabel(relief = None, guiId = 'DownloadWatcherText', pos = (-0.95999999999999996, 0, -0.91000000000000003), text = Localizer.DownloadWatcherInitializing, text_fg = (1, 1, 1, 1), text_scale = 0.050000000000000003, textMayChange = 1, text_align = TextNode.ALeft, sortOrder = 50)
    ...
    def update(self, phase, percent, reqByteRate, actualByteRate):
        ...
        self.text['text'] = Localizer.DownloadWatcherUpdate % phaseName
